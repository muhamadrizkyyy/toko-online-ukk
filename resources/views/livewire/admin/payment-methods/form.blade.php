<div>
    <div
        ...
        <div class="w-full mb-1">
            <div>
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Form Payment Method</h1>
            </div>
        </div>
    </div>
    <div
        ...
        <div class="grid grid-cols-6 gap-6 w-full">
            ...
            <div class="col-span-6 sm:col-span-3">
                <label for="no_rek" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                    No Rekening
                </label>
                <input type="text" name="no_rek" id="no_rek" wire:model='no_rek'
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="9019734978xxx">
                @error('no_rek')
                    <span class="text-xs text-red-600 font-bold">{{ $message }}</span>
                @enderror
            </div>
