            ...
            <div class="sm:flex">
                <div
                    ...
                    <button type="button" wire:click='print'
                        class="text-white place-self-end bg-green-500 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">
                        Print
                    </button>
                </div>
            </div>
