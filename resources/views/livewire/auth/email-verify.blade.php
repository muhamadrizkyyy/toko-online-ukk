<div>
    <div class="flex flex-col items-center justify-center px-6 pt-8 mx-auto md:h-screen pt:mt-0 dark:bg-gray-900">
        ...
        <div class="w-full max-w-xl sm:p-8 bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <p class="my-4">
                We have sent an email to your email address. Please check your email and click on the verification link
                to verify your account.
            </p>
            <form action="{{ route('verification.send') }}" method="post">
                @csrf
                <button type="submit" class="px-3 py-2 bg-blue-700 text-white rounded-md hover:bg-blue-600">
